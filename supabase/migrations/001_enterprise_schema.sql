...
INSERT INTO defense_catalog (code, name, description) VALUES
  ...
  ('D002', 'عدم توفر الأركان', 'عدم توفر أحد أركان الجريمة المادية أو المعنوية'),
  ...
  ('D007', 'الإعفاء من العقوبة', 'الإعفاء من العقوبة بسبب حالات الضرورة القصوى أو الأعذار المعفية')
