...
export const SEED_ARTICLES: SeedArticle[] = [
  ...
  },
  {
    ...
    body: "الطعن بالنقض في الأحكام الجنائية يتقدم خلال ستين يوماً يبدأ سريانها من تاريخ الإعلان بالحكم المستأنف أو المؤيد. ولا يجوز تمديد هذه المدة ولا وقف سريانها لسبب وجيه ولا لظروف القاهرة وما شابه.",
    category: "criminal",
  ...
  },
  {
    ...
    body: "يقرر قاضي التحقيق أو النيابة العامة الإفراج عن المتهم بكفالة تقدر بحسب الجريمة والظروف. وتحدد المادة مقدار الكفالة الابتدائي وتخويل المحكمة تخفيضه أو زيادته. وتُقبض الكفالة نقداً أو بكفيل مختار أو بخطاب ضمان مصدق.",
    category: "criminal",
  },
  {
    sourceKey: "cpp-150",
    number: "35",
    title: "تسليم النفس والقبض على ذي يد",
    body: "يُقدم المتهم نفسه بنفسه إلى النيابة العامة أو قسم الشرطة، وتحرر محضراً بذلك. ويمكن لكل من ضُبط متلبساً بارتكاب جنحة أن يُحال على النيابة خلال المدة القانونية، ولا يجوز حبس المتهم بعد مرور 24 ساعة من وروده المركز إلا بأمر من قاضي التحقيق.",
    category: "criminal",
  ...
  },
  {
    sourceKey: "cpp-150",
    number: "25",
    title: "رفع الدعوى بالبلاغ والمحاضر",
    body: "تُرفع الدعوى الجنائية بشكاية المضرور أو بلاغ النيابة أو محضر الضبط. ولا تُقبل الشكاية إلا من ذي مصلحة أصيلة، ويحق للمُبلغ طلب إثبات حالته وطلبه حجزه في المحضر.",
    category: "criminal",
  },
  // ---- قانون العقوبات 58/1937 ----
  {
    ...
    body: "كل من زوّر في محرر رسمي أو استعماله عمداً مع علمه بتزويره يُعاقب بالأشغال المؤقتة. ويعتبر تزويراً كل تغيير غادر في الحقيقة يترتب عليه ضرر، وإضافة كلام منسوب إلى شخص في محرر أصيل، وإسناد أقوال أو توقيع إلى من لم يؤشر.",
    category: "criminal",
  },
  {
    sourceKey: "penal-58",
    number: "112",
    title: "البلاغ الكاذب (الإخبار الكاذب)",
    body: "عقوبة الإخبار الكاذب إلى الجهات الرسمية عن جريمة لم تحدث: الحبس وبغرامة. وتُشد العقوبة إذا كان المُبلغ قد أقسم أمام الجهة المختصة. ويحق للمُتَّهم كذباً برفع دعوى تعويض عن الضرر الناتج.",
    category: "criminal",
  },
  {
    sourceKey: "penal-58",
    number: "409",
    title: "الابتزاز",
    body: "يعاقب على من استعمل التهديد بكشف أمور مسيئة أو باتهام كاذب بقصد الابتزاز بالحبس وبغرامة. ويرد المادة على الابتزاز بالرسائل أو الوسائل الإلكترونية إذا تضافرت مع قانون جرائم تقنية المعلومات 175/2018.",
    category: "criminal",
  },
  {
    sourceKey: "penal-58",
    number: "414",
    title: "خيانة الأمانة",
    body: "عقوبة خيانة الأمانة في النقود أو الأوراق أو غيرها المُسلَّمة بكل من سبق من الأمانات المبينة بالقانون: الحبس. وترتقي العقوبة عند خيانة الأمانة في وثيقة رسمية أو مال عام. ولا تقوم خيانة الأمانة دون إثبات تسليم المال بصفة أمانة.",
    category: "criminal",
  },
  // ---- دستور 2014 ----
  {
    ...
    body: "الحق في الأمان حق للجميع. ولا يجوز القبض أو تفتيش أو حجز أو حبس أي شخص إلا بأمر مسبب من القضاء. ويُبّه كل من يُقبض عليه بحقه بحالته فوراً ولا يجوز تعذيه أو إيذاؤه.",
    category: "criminal",
  },
  {
    sourceKey: "const-2014",
  ...
  // ---- قانون جرائم تقنية المعلومات 175/2018 ----
  {
    ...
    body: "يعاقب بالحبس وبغرامة لا تقل عن ستة أشهر وغرامة لا تقل عن خمسين ألف جنيه كل من ارتكب فعل الابتزاز الإلكتروني بتهديد المضرور بكشف معلومات أو صور أو تسجيلات مهينة بحق فعله أو عدم فعله.",
    category: "digital",
  },
  {
    sourceKey: "cyber-175",
    ...
    body: "يعاقب بالحبس وبغرامة كل من انتحل شخصية غيره في التعاملات الإلكترونية أو وصل إلى موقع إلكتروني أو حساب خاص دون حق أو احتفظ عمداً ببيانات دخول لم تُسلم إليه.",
    category: "digital",
  },
  // ---- بوابة النيابة العامة الرقمية ----
  {
    sourceKey: "pp-portal",
    number: "استعلام-القضايا",
    title: "استعلام عن القضايا إلكترونياً",
    body: "تتيح بوابة النيابة العامة الرقمية خدمة استعلام عن القضايا للأشخاص المتضررين من إيصالات الأمانة المزورة والمحاضر الكيدية عبر إدخال بيانات البطاقة والرقم الوطني والرقم السري. وتُظهر الخدمة رقم القضية وحالتها الإجرائية.",
    category: "procedure",
  },
];
    ...
    services: [
      {
        ...
        steps: [
          ...
          "أدخل بيانات البطاقة والرقم القومي والرقم السري.",
          "ادخل رقم القضية إن توفر، أو استعلم بالاسم.",
          "اطبع أو خذ صورة من نتيجة الاستعلام.",
        ],
      },
      {
    ...
    services: [
      {
        ...
        description: "طلب شهادات ومستندات رسمية معتمدة عبر مصر الرقمية.",
...
// ============================================================
// Procedure guides — تروح فين؟ وتتعامل مع مين؟ / ماذا أفعل الآن؟
// ============================================================
...
export const SEED_PROCEDURES: SeedProcedure[] = [
  {
    ...
    summary:
      "لو اتحاكمت بإيصال أمانة، حقك تطلب طعن بالتزوير وإحالة المحرر للطب الشرعي للكتابة وتحديد عمر الحبر.",
    steps: [
      "لا توقع على أي شيء في قسم الشرطة واطلب محضر إثبات حالة.",
      "اذهب إلى النيابة العامة المختصة وقدّم طلب الطعن بالتزوير.",
      "اطلب إحالة المحرر إلى قسم تزييف وتزوير الخطوط بمصلحة الطب الشرعي.",
      "قدّم الدفوع بعدم تسليم المبالغ إذا لم يتم تسليم شيء فعلياً.",
      "احتفظ بكل المستندات والرسائل في ملف منظّم.",
    ],
    documentsNeeded: [
      "صورة من الإيصال موضوع الطعن",
      "بطاقة الرقم القومي",
      "أي مراسلات مع الطرف الآخر",
      "كشف حساب بنكي إذا تخص الموضوع",
    ],
  ...
  },
  {
    ...
    summary:
      "لو اتصلت من قسم الشرطة على محضر كيدي، من حقك الاطلاع على المحضر قبل أي إفادة وتقديم بلاغ مضاد للابتزاز.",
    steps: [
      ...
      "احتفظ بأي رسائل أو تسجيلات تثبت الرواية.",
    ],
    documentsNeeded: [
    ...
    warnings: ["لا تتعامل مع أي وسيط أو مخابر — التعامل رسمي فقط عبر الجهات الرسمية."],
    sourceKey: "cpp-150",
  },
  {
    ...
    summary:
      "المواعيد صارمة: المعارضة 10 أيام، الاستئناف في الجنح 10 أيام، النقض 60 يوماً من الإعلان.",
    steps: [
      ...
      "اطلب إثبات بتاريخ التقديم (ختم كتاب المحكمة).",
    ],
...
export const SEED_RIGHTS: SeedRight[] = [
  {
    ...
    summary: "القبض والحجز يمران بأمر قضائي مسبب، ولك حق الأمان ومعرفة تهمتك فوراً.",
    points: [
      "لا يجوز القبض أو التفتيش أو الحجز إلا بأمر مسبب من القضاء (دستور 54).",
      "يُبَّه كل من يُقبض عليه فوراً بحالته ولا يجوز إيذاؤه (دستور 54).",
      "لا يجوز حبس المتهم بعد 24 ساعة من وروده المركز إلا بأمر من قاضي التحقيق (إ.ج 35).",
      "المتهم بريء حتى تثبت إدانته في محاكمة عادلة (دستور 96).",
    ],
    sourceKey: "const-2014",
  },
  {
    ...
    summary: "الابتزاز الإلكتروني جريمة معاقب عليها بقانون جرائم تقنية المعلومات.",
    points: [
      ...
      "لا تتعامل مع المُبتز ولا تتفاوض معه.",
    ],
    sourceKey: "cyber-175",
  },
  {
    ...
    points: [
      "الإخبار الكاذب للجهات الرسمية جريمة يعاقب عليها القانون (ع.ع 112).",
      "يحق لك طلب إثبات حالة في نفس القسم لتوثيق روايتك.",
      "يحق للمُتضرر من البلاغ الكاذب الدعوى المدنية للتعويض.",
...
export const SEED_EVAL_CASES: EvalCase[] = [
  {
    ...
    notes: "مادة 295 إ.ج — إجابة مادية من مصدر منشور.",
  },
  {
    code: "TEST-002",
    question: "ما حكم الاستحمام في يوم الجمعية العامة للشركة القابضة؟",
    domain: "irrelevant",
  ...
  {
    code: "TEST-004",
    question: "ما هي مدة الاستئناف في الجنح بعد تعديل 2027 الجديد؟",
    domain: "criminal-procedure",
    expectedEvidenceStatus: "INSUFFICIENT_EVIDENCE",
    expectAbstain: false,
    notes: "لا توجد معرفة عن تعديل 2027 — يجب الإقرار بعدم وجود أدلة عن التعديل المذكور.",
  },
  {
    code: "TEST-005",
    ...
    expectAbstain: false,
    notes: "كلاهما 10 أيام في المصادر — لا يجب أن يُصرّح النظام بتعارض لا يوجد؛ هذا الاختبار يتحقق من عدم الكشف الزائف.",
  },
  {
    code: "TEST-006",
  ...
  },
  {
    ...
    expectAbstain: false,
    expectedSourceTitle: "قانون العقوبات رقم 58 لسنة 1937 ولتعديلاته",
    notes: "أساس التزوير م215 ع.ع + إجراءات من دليل النيابة.",
  },
  {
    code: "TEST-009",
  ...
  {
    code: "TEST-010",
    question: "ما هي مدة الطعن بالنقض في القضايا الجنائية حسب قديم؟",
    domain: "criminal-procedure",
